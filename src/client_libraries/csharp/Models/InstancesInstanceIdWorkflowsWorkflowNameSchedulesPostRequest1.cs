...
namespace Microsoft.Dynamics.CustomerInsights.Api.Models
{
    ...
    /// </summary>
    public partial class InstancesInstanceIdWorkflowsWorkflowNameSchedulesPostRequest1 : WorkflowRefreshSchedule
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public InstancesInstanceIdWorkflowsWorkflowNameSchedulesPostRequest1()
        {
            CustomInit();
        }
        ...
        public InstancesInstanceIdWorkflowsWorkflowNameSchedulesPostRequest1(string operationType = default(string), string subType = default(string), IList<string> identifiers = default(IList<string>), string jobType = default(string), bool? isActive = default(bool?), string timezoneId = default(string), IList<string> cronSchedules = default(IList<string>), System.Guid? scheduleId = default(System.Guid?), System.Guid? instanceId = default(System.Guid?))
