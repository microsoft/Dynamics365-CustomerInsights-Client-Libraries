...
namespace Microsoft.Dynamics.CustomerInsights.Api.Models
{
    ...
    public partial class CreatedResult
    {
        ...
        /// Initializes a new instance of the CreatedResult class.
        /// </summary>
        public CreatedResult(string location = default(string), object value = default(object), IList<object> formatters = default(IList<object>), IList<string> contentTypes = default(IList<string>), string declaredType = default(string), int? statusCode = default(int?))
        {
            Location = location;
            Value = value;
