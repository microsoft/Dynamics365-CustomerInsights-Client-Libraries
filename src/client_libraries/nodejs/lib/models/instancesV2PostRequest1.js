 ...
 */
class InstancesV2PostRequest1 extends models['InstanceCreationRequest'] {
  /**
   * Create a InstancesV2PostRequest1.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of InstancesV2PostRequest1
   *
   * @returns {object} metadata of InstancesV2PostRequest1
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'InstancesV2PostRequest-1',
      type: {
        name: 'Composite',
        className: 'InstancesV2PostRequest1',
        modelProperties: {
          instanceMetadata: {
            required: false,
...
module.exports = InstancesV2PostRequest1;
