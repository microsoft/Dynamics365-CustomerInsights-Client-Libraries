 ...
 */
class InstancesInstanceIdManageMeasuresPostRequest1 extends models['MeasureMetadata'] {
  /**
   * Create a InstancesInstanceIdManageMeasuresPostRequest1.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of InstancesInstanceIdManageMeasuresPostRequest1
   *
   * @returns {object} metadata of InstancesInstanceIdManageMeasuresPostRequest1
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'Instances-instanceId-ManageMeasuresPostRequest-1',
      type: {
        name: 'Composite',
        className: 'InstancesInstanceIdManageMeasuresPostRequest1',
        modelProperties: {
          displayName: {
            required: false,
...
module.exports = InstancesInstanceIdManageMeasuresPostRequest1;
