 ...
 */
class InstancesInstanceIdManageSegmentsPostRequest1 extends models['SegmentMetadata'] {
  /**
   * Create a InstancesInstanceIdManageSegmentsPostRequest1.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of InstancesInstanceIdManageSegmentsPostRequest1
   *
   * @returns {object} metadata of InstancesInstanceIdManageSegmentsPostRequest1
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'Instances-instanceId-ManageSegmentsPostRequest-1',
      type: {
        name: 'Composite',
...
module.exports = InstancesInstanceIdManageSegmentsPostRequest1;
