 ...
 *
 */
class HistoricalSegmentStats {
  /**
   * Create a HistoricalSegmentStats.
   * @property {date} [evaluationDate] Gets the segment ran date.
   * @property {number} [entityCount] Gets the count of entity.
   * @property {string} [jobStatus] Gets the segment evaluation job status.
  ...
  /**
   * Defines the metadata of HistoricalSegmentStats
   *
   * @returns {object} metadata of HistoricalSegmentStats
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'HistoricalSegmentStats',
      type: {
        name: 'Composite',
...
module.exports = HistoricalSegmentStats;
