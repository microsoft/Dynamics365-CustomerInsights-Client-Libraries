...
class MappedSecretMetadata(Model):
    ...
    def __init__(self, *, mapped_field_id: str=None, linked_key_vault_metadata_id: str=None, mapping_entity_id: str=None, byo_key_vault_field_mapping=None, instance_id: str=None, **kwargs) -> None:
        super(MappedSecretMetadata, self).__init__(**kwargs)
        self.mapped_field_id = mapped_field_id
        self.linked_key_vault_metadata_id = linked_key_vault_metadata_id
        self.mapping_entity_id = mapping_entity_id
        self.byo_key_vault_field_mapping = byo_key_vault_field_mapping
