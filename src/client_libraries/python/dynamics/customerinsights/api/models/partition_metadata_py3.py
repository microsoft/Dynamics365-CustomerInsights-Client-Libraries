...
class PartitionMetadata(Model):
    ...
    def __init__(self, *, name: str=None, location: str=None, refresh_time=None, file_format_settings=None, force_sas_auth: bool=None, has_header: bool=None, **kwargs) -> None:
