...
class InstancesCopyPostRequest1(InstanceCopyRequest):
    ...
    def __init__(self, *, instance_id_to_copy: str=None, instance_metadata=None, byosa_resource_metadata=None, cds_resource_metadata=None, byo_pbi_provisioning_info=None, is_cds_mdl_storage_enabled: bool=None, is_ci_to_byosa_migration_enabled: bool=None, bap_provisioning_type=None, is_pbi_provisioning_required: bool=None, **kwargs) -> None:
        super(InstancesCopyPostRequest1, self).__init__(instance_id_to_copy=instance_id_to_copy, instance_metadata=instance_metadata, byosa_resource_metadata=byosa_resource_metadata, cds_resource_metadata=cds_resource_metadata, byo_pbi_provisioning_info=byo_pbi_provisioning_info, is_cds_mdl_storage_enabled=is_cds_mdl_storage_enabled, is_ci_to_byosa_migration_enabled=is_ci_to_byosa_migration_enabled, bap_provisioning_type=bap_provisioning_type, is_pbi_provisioning_required=is_pbi_provisioning_required, **kwargs)
