...
class InstanceCopyRequest(Model):
    ...
    def __init__(self, *, instance_id_to_copy: str=None, instance_metadata=None, byosa_resource_metadata=None, cds_resource_metadata=None, is_cds_mdl_storage_enabled: bool=None, is_ci_to_byosa_migration_enabled: bool=None, bap_provisioning_type=None, is_pbi_provisioning_required: bool=None, is_dataverse_update_requested: bool=None, **kwargs) -> None:
