...
class InstancesInstanceIdWorkflowsWorkflowNameSchedulesPostRequest(WorkflowRefreshSchedule):
    ...
    def __init__(self, *, operation_type=None, sub_type=None, identifiers=None, job_type=None, is_active: bool=None, timezone_id: str=None, cron_schedules=None, schedule_id: str=None, instance_id: str=None, **kwargs) -> None:
        super(InstancesInstanceIdWorkflowsWorkflowNameSchedulesPostRequest, self).__init__(operation_type=operation_type, sub_type=sub_type, identifiers=identifiers, job_type=job_type, is_active=is_active, timezone_id=timezone_id, cron_schedules=cron_schedules, schedule_id=schedule_id, instance_id=instance_id, **kwargs)
