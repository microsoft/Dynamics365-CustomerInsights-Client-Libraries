...
class GraphJobOptions(Model):
    ...
    def __init__(self, *, additional_properties=None, run_downstream_after_merge: bool=None, **kwargs) -> None:
        super(GraphJobOptions, self).__init__(**kwargs)
        self.additional_properties = additional_properties
        self.run_downstream_after_merge = run_downstream_after_merge
