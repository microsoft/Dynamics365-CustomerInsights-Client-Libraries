...
class CIResult(Model):
    ...
    def __init__(self, *, exception_culprit=None, error_code: str=None, result_severity=None, message: str=None, name: str=None, params=None, ci_results=None, **kwargs) -> None:
