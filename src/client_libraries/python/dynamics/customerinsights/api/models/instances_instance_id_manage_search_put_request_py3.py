...
class InstancesInstanceIdManageSearchPutRequest(InstanceSearchConfiguration):
    ...
    def __init__(self, *, entity_config=None, is_system_generated: bool=None, version: int=None, updated_by: str=None, updated_utc=None, created_by: str=None, created_utc=None, instance_id: str=None, **kwargs) -> None:
        super(InstancesInstanceIdManageSearchPutRequest, self).__init__(entity_config=entity_config, is_system_generated=is_system_generated, version=version, updated_by=updated_by, updated_utc=updated_utc, created_by=created_by, created_utc=created_utc, instance_id=instance_id, **kwargs)
