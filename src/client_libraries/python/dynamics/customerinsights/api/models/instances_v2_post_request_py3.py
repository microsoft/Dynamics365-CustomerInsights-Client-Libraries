...
class InstancesV2PostRequest(InstanceCreationRequest):
    ...
    def __init__(self, *, instance_metadata=None, byosa_resource_metadata=None, cds_resource_metadata=None, bap_provisioning_type=None, **kwargs) -> None:
        super(InstancesV2PostRequest, self).__init__(instance_metadata=instance_metadata, byosa_resource_metadata=byosa_resource_metadata, cds_resource_metadata=cds_resource_metadata, bap_provisioning_type=bap_provisioning_type, **kwargs)
