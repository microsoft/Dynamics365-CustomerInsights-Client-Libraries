...
class ApiErrorResult(Model):
    ...
    :param http_status_code: Possible values include: 'continue',
    ...
    def __init__(self, *, http_status_code=None, exception_culprit=None, error_code=None, result_severity=None, message: str=None, params=None, ci_results=None, **kwargs) -> None:
