...
class SegmentMetadata(Model):
    ...
    :type segment_query_expression:
     ~microsoft.dynamics.customerinsights.api.models.SegmentationQuery
    :param state: Possible values include: 'inactive', 'active', 'validating',
     'validated', 'invalid', 'validationError'
    :type state: str or ~microsoft.dynamics.customerinsights.api.models.enum
    ...
    :type evaluation_status:
     ~microsoft.dynamics.customerinsights.api.models.SegmentationPublishStats
    ...
    :type evaluation_status_history:
     list[~microsoft.dynamics.customerinsights.api.models.HistoricalSegmentStats]
    ...
    def __init__(self, *, name: str=None, friendly_name: str=None, description: str=None, segment_query_expression=None, state=None, error_description: str=None, end_date=None, evaluation_status=None, sql_validation_stats=None, evaluation_status_history=None, **kwargs) -> None:
        ...
        self.segment_query_expression = segment_query_expression
        self.state = state
