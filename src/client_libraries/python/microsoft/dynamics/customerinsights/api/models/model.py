...
class Model(Model):
    ...
    :param pbimashup:
    :type pbimashup: ~microsoft.dynamics.customerinsights.api.models.Mashup
    :ivar annotations:
    :vartype annotations:
     list[~microsoft.dynamics.customerinsights.api.models.Annotation]
    :ivar entities:
    :vartype entities:
     list[~microsoft.dynamics.customerinsights.api.models.Entity]
    :ivar relationships:
    :vartype relationships:
     list[~microsoft.dynamics.customerinsights.api.models.Relationship]
    :ivar reference_models:
    :vartype reference_models:
     list[~microsoft.dynamics.customerinsights.api.models.ReferenceModel]
    """
