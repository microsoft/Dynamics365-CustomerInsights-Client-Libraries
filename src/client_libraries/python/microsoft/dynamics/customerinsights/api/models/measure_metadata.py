...
class MeasureMetadata(Model):
    ...
    :param definition:
    :type definition:
     ~microsoft.dynamics.customerinsights.api.models.MeasureDefinition
    :param latest_evaluation:
    :type latest_evaluation:
     ~microsoft.dynamics.customerinsights.api.models.Evaluation
    :param output:
    :type output: ~microsoft.dynamics.customerinsights.api.models.ScalarOutput
    :param evaluation_stats:
    :type evaluation_stats:
     ~microsoft.dynamics.customerinsights.api.models.EvaluationStats
    :param error_description:
    :type error_description:
     ~microsoft.dynamics.customerinsights.api.models.StringInfo
    :param sql_validation_stats:
    :type sql_validation_stats:
     ~microsoft.dynamics.customerinsights.api.models.SqlValidationStats
    :param evaluation_history: Gets the evaluation history for the measure.
     (not persisted in store)
    :type evaluation_history:
     list[~microsoft.dynamics.customerinsights.api.models.Evaluation]
    :param output_history: Gets the output history for the measure. (not
     persisted in store)
    :type output_history:
     list[~microsoft.dynamics.customerinsights.api.models.ScalarOutput]
