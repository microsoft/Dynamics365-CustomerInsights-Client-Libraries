 ...
 */
public class UpdateARelationshipHeaders {
    /**
     * Bearer.
     */
     ...
     * @return the UpdateARelationshipHeaders object itself.
     */
    public UpdateARelationshipHeaders withWWWAuthenticate(String wWWAuthenticate) {
