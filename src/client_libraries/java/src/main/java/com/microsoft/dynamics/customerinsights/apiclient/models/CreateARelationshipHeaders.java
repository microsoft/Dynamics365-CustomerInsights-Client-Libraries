 ...
 */
public class CreateARelationshipHeaders {
    /**
     * Bearer.
     */
     ...
     * @return the CreateARelationshipHeaders object itself.
     */
    public CreateARelationshipHeaders withWWWAuthenticate(String wWWAuthenticate) {
