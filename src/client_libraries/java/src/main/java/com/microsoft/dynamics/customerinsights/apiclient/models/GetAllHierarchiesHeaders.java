 ...
 */
public class GetAllHierarchiesHeaders {
    /**
     * Bearer.
     */
     ...
     * @return the GetAllHierarchiesHeaders object itself.
     */
    public GetAllHierarchiesHeaders withWWWAuthenticate(String wWWAuthenticate) {
