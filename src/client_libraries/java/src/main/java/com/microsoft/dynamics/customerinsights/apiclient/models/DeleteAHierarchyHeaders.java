 ...
 */
public class DeleteAHierarchyHeaders {
    /**
     * Bearer.
     */
     ...
     * @return the DeleteAHierarchyHeaders object itself.
     */
    public DeleteAHierarchyHeaders withWWWAuthenticate(String wWWAuthenticate) {
