 ...
 */
public class DeactivateSegmentHeaders {
    /**
     * Bearer.
     */
     ...
     * @return the DeactivateSegmentHeaders object itself.
     */
    public DeactivateSegmentHeaders withWWWAuthenticate(String wWWAuthenticate) {
