...
class AttributeDataProfile(Model):
    ...
    :type value_counts:
     list[~microsoft.dynamics.customerinsights.api.models.ValueCount]
    :param histogram: Gets or sets the histogram information. Ordered from
     smallest to largest bin.
    :type histogram:
     list[~microsoft.dynamics.customerinsights.api.models.HistogramBin]
    ...
    :type string_length_counts:
     list[~microsoft.dynamics.customerinsights.api.models.StringLengthCount]
    ...
    :param quantiles:
    :type quantiles: ~microsoft.dynamics.customerinsights.api.models.Quantiles
    :param moments:
    :type moments: ~microsoft.dynamics.customerinsights.api.models.Moments
